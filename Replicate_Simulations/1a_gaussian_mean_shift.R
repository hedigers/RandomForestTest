...
Results <- parSim(
  ...
  expression = {
    ...
    ################################# DATA GENERATION #################################
    mean_alt <- c(rep(mean_shift/sqrt(p),p))
...
# write.table(Results, "1a_results_meanshift_S200_p200_n600_trees600_node4_K100.txt", sep=";")
# Results <- read.table("1a_results_meanshift_S200_p200_n600_trees600_node4_K100.txt", sep=";")
# library(tikzDevice)
# options(tikzDefaultEngine = 'xetex')
# tikz(file = "1a_plot_gaussian_meanshift.tex", width=6, height=4)
# 
# par(oma = c(1, 1, 2, 1))
# plot(Results$mean_shift, Results$power_perm, xlab='$\\delta$',
#      ylab="Power", pch=19, type="b", ylim=c(0,1), col="red4")
# lines(Results$mean_shift, Results$power_binom, col="tomato", pch=17, type="b")
# lines(Results$mean_shift, Results$power_me, col="skyblue3", pch=15, type="b")
# lines(Results$mean_shift, Results$power_mmd, col="snow4", pch=3, type="b")
# lines(Results$mean_shift, Results$power_mmdopt, col="palegreen4", pch=4, type="b")
# # lines(Results$mean_shift, Results$power_scf, col="hotpink3", pch=7, type="b")
